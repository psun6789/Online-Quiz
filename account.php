...
<!-- this is the Account Page for the quiz application -->

<title>Psun Academy</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Psun Academy</span></div>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Psun Academy</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Psun Academy</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/logo.jpg" width=100 height=100 alt="Psun" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Psun Academy</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9964236497</h4>
		<h4 style="font-family:'typo' ">psunacademy@gmail.com</h4>
		<h4 style="font-family:'typo' ">Basavanagar Part-1st, Haliyal Road Dharwad</h4></div></div>
		</p>
      </div>
